...
The originai `ttf-parser` is dual licensed under the MIT License and the Apache 2.0 License. This Zig library is, however, licensed under the Mozilla Public License 2.0.
